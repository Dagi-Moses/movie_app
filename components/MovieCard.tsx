...
type MovieCardProps = Movie & {
  isBookmarked?: boolean; // optional, defaults to false
};
const MovieCard = ({
  id,
  poster_path,
    ...
    >
      <TouchableOpacity className='w-[30%]'>
        <Image
          ...
          resizeMode='cover'
        />
        <Text className='text-sm font-bold text-white mt-2' numberOfLines={isBookmarked ? 2 : 1}>{title}</Text>
